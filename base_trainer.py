...
class Base_Trainer():
    def __init__(self, cfg_data, pwd):
        ...
        self.train_loader, self.val_loader, self.restore_transform = datasets.loading_data('FDST')
        ...
        model_path = '/data/gjy/Projects/DPD/code/Projects/exp/05-25_16-33_SHHA_VGG16_FPN/ep_307_F1_0.742_Pre_0.674_Rec_0.824_mae_6.6_mse_9.9.pth'
    ...
    def train(self): # training for all datasets
        ...
        for i, data in enumerate(self.train_loader, 0):
            ...
            lr1,lr2 = adjust_learning_rate(self.optimizer,
                            ...
                            self.i_tb)
            sys.stdout.write('\r')
            sys.stdout.write('Epoch [%3d/%3d] Iter[%3d/%3d] Loss: [%.4f, %.4f] Thre: [%.3f|%.3f|%.3f]'
                    %(self.epoch + 1, 600, i + 1, len(self.train_loader), head_map_loss.item(), binar_map_loss.item(), threshold_matrix.max().item(), threshold_matrix.mean().item(), threshold_matrix.min().item()))
            sys.stdout.flush()
